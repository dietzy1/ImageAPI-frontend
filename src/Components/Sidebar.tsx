function Sidebar() {
  return (
    <div>
      <div className="fixed top-24 left-10 h-screen w-[68] m-0 flex flex-col whitespace-nowrap text-bold border-r-[1px] text-[#888]">
        <h1 className="mb-5 text-xl">API-documentation</h1>
        <ul>
          <h1 className="text-l m-3">Getting started</h1>
          <div className="m-3 ml-6 font-semibold underline">
            <li>API access</li>
            <li>Registration</li>
