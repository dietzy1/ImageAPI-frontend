            ...
            <div className=" lg:px-8 pb-8 mt-8 text-[#fff] text-base font-normal lg:border-x border-gray-500 lg:border-b antialiased">
              ...
              <div className=" pl-4 mb-10 mt-2">
                ...
                <div className="flex flex-col py-2">
                  ...
                  <span className="mb-6">
                    Register for API usage by clicking the sign up buttom at the
                    top right. This part is done purely to ratelimit overly
                    excessive use. Once you have been successfully registered as
                    a user, go ahead and click the account button at the top
                    right which leads to the account page.
                  </span>
                  ...
                  <span className="mb-6">
                    ...
                    API. Incase your key has been compromised, you can generate
                    a new one at any time, however only one key can be active at
                    a time.
                  </span>
                  ...
                  <span className="mb-6">
                    ...
                    with a fair usecase. However I do reserve myself the right
                    to terminate any user incase of malicious interaction.
                  </span>
                  ...
                  <span className="mb-6">
                    If a single image is requested then a single json object
                  ...
                  <span className="mb-6">
                    The API key is a requirement for authentication. It is
                    therefor a request requirement that the API key is appended
                    to the request URL.
                  </span>

                  <span className="mb-6">
                    The API key field is coded as a query parameter, therefor
                    the query should be started with ?=key{"{key}"}. It is
                    important to note that unless this query parameter is filled
                    out correctly, the response will be a 401 Unauthorized.
                  </span>
                  ...
                  <span className="mb-6">
                    It is good practise to keep the API-key in a env/config
                    file, and read in the key in order to not expose the key.
                  ...
                  <span className="mb-6">
                    A simple discord bot function written in Go with the
                    discordgo library that returns a random pepe image.
                  </span>
